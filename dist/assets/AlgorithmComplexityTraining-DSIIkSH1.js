import{r as u,j as r}from"./index-CrIcAvpG.js";const T=["O(1)","O(n)","O(n log n)","O(n^2)","O(n^3)","O(n!)","O(2^n)"],N=[{id:"array-access",title:"Доступ к элементу массива по индексу",code:`def get_element(arr, index):
