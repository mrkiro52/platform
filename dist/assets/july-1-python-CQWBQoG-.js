import{j as e}from"./index-CyqjtO_H.js";import{T as s,b as n,a}from"./TheoryTable-Dd-ydXYT.js";import{M as r,P as t}from"./MultiPartVideo-CHppsjqn.js";import"./VideoPlayer-myyarhKi.js";function c(){return e.jsxs("div",{className:"theory-container",children:[e.jsxs("section",{className:"theory-section",children:[e.jsx("h1",{className:"theory-title",children:"Основы Python"}),e.jsx("p",{className:"theory-subtitle",children:"Треки: Аналитика данных и Machine Learning"}),e.jsx("p",{className:"theory-date",children:"1 июля 2026"}),e.jsx("p",{children:"Перед стартом специализации вспоминаем фундамент Python — язык, на котором строится вся современная аналитика и ML. Здесь собрано всё базовое: типы данных, коллекции, условия, циклы, функции. В конце — анонс библиотек, с которыми будем работать дальше."})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"Видео-лекция: Основы Python (4 части)"}),e.jsx(r,{parts:t})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"1. Переменные и типы данных"}),e.jsx("p",{children:"Переменная — это имя, связанное со значением. В Python не нужно объявлять тип заранее: интерпретатор сам определяет его по значению (динамическая типизация)."}),e.jsx(s,{language:"python",code:`x = 42            # int  — целое число
