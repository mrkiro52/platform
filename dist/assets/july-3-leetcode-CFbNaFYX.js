...
`:""]},n);const d=r.slice(0,t),x=(d.match(/'/g)||[]).length,p=(d.match(/"/g)||[]).length;return x%2!==0||p%2!==0?e.jsxs("span",{children:[r,n<c.length-1?`
