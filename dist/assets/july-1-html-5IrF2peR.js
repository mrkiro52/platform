import{j as e}from"./index-CE9LDsEt.js";import{T as s,a as l,b as i}from"./TheoryTable-Dogc9yHv.js";function t(){return e.jsxs("div",{className:"theory-container",children:[e.jsxs("section",{className:"theory-section",children:[e.jsx("h1",{className:"theory-title",children:"Основы HTML"}),e.jsx("p",{className:"theory-subtitle",children:"Трек: Frontend-разработка"}),e.jsx("p",{className:"theory-date",children:"1 июля 2026"}),e.jsx("p",{children:"HTML (HyperText Markup Language) — язык разметки, «скелет» любой веб-страницы. Он не программирует логику, а описывает структуру: что тут заголовок, что абзац, что картинка, что ссылка. Браузер читает HTML и рисует страницу."})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"1. Структура HTML-документа"}),e.jsx("p",{children:"Любая страница начинается с одинакового каркаса:"}),e.jsx(s,{language:"html",code:`<!DOCTYPE html>
<html lang="ru">
  <head>
    <meta charset="UTF-8">
