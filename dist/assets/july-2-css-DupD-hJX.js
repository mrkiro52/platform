import{j as e}from"./index-21l4SgQ0.js";import{T as s,b as i,a as r}from"./TheoryTable-CgRgMtXw.js";function t(){return e.jsxs("div",{className:"theory-container",children:[e.jsxs("section",{className:"theory-section",children:[e.jsx("h1",{className:"theory-title",children:"Основы CSS"}),e.jsx("p",{className:"theory-subtitle",children:"Трек: Frontend-разработка"}),e.jsx("p",{className:"theory-date",children:"2 июля 2026"}),e.jsxs("p",{children:["CSS (Cascading Style Sheets) — язык, который отвечает за ",e.jsx("strong",{children:"внешний вид"})," HTML-страницы: цвета, отступы, шрифты, расположение блоков. HTML описывает структуру («что это»), а CSS — как это должно выглядеть."]})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"1. Как подключить CSS и синтаксис правил"}),e.jsx(s,{language:"html",code:`<!-- Внешний файл стилей — основной способ -->
