...
}`}),e.jsxs(c,{title:"@import vs @use",children:["Раньше подключали через ",e.jsx("code",{children:"@import"}),", но у него были проблемы: файл мог импортироваться несколько раз, а все переменные попадали в общую глобальную область. Современный Sass рекомендует",e.jsx("code",{children:" @use"})," — импортирует файл один раз и требует явно указывать модуль (",e.jsx("code",{children:"variables.$primary"}),"), что делает код понятнее."]})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"8. Всё вместе: пример карточки"}),e.jsx(s,{language:"scss",code:`$primary: #FFD60A;
$radius: 10px;
