...
np.unique(vals, return_counts=True)   # ещё и сколько раз каждое: ([1,2,3], [1,2,3]) → 1 встретилось 1 раз, 2 — дважды, 3 — трижды`})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"5. Пропущенные значения (NaN)"}),e.jsx(i,{name:"np.nan (Not a Number)",children:"специальное значение «нет данных». В реальных датасетах пропуски встречаются постоянно, и с ними надо уметь работать: обычные суммы/средние «ломаются» об NaN."}),e.jsx(s,{language:"python",code:`a = np.array([1, 2, np.nan, 4])   # третий элемент — пропуск (нет данных)
...
a[~np.isnan(a)]  # ~ инвертирует маску (True→False). Оставляем только НЕ-пропуски: [1. 2. 4.]`})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"Часть 2. Знакомство с Pandas"}),e.jsxs(i,{name:"pandas",children:["библиотека для работы с ",e.jsx("strong",{children:"табличными данными"}),", построенная поверх NumPy. Даёт две структуры: ",e.jsx("strong",{children:"Series"})," (одна колонка) и ",e.jsx("strong",{children:"DataFrame"})," (целая таблица с именованными колонками и индексом). Это главный инструмент любого аналитика данных."]}),e.jsx(s,{language:"bash",code:"pip install pandas   # ставим библиотеку (NumPy подтянется автоматически как зависимость)"}),e.jsx(s,{language:"python",code:"import pandas as pd   # импортируем; pd — общепринятое сокращение, пиши всегда так"})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"6. Series и DataFrame"}),e.jsxs(i,{name:"Series",children:["одномерный маркированный массив: значения + ",e.jsx("strong",{children:"индекс"})," (метки). Похож на колонку таблицы или на словарь, но с возможностями NumPy."]}),e.jsx(i,{name:"DataFrame",children:"двумерная таблица: набор Series-колонок с общим индексом строк. Именно с DataFrame аналитик проводит большую часть времени."}),e.jsx(s,{language:"python",code:`# Series — одна колонка со своими метками (index)
