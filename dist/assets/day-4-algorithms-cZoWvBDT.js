import{j as e}from"./index-BlnQ7002.js";import{a as r,T as s,b as l}from"./TheoryTable-BDiL0XX6.js";import{V as n}from"./VideoPlayer--csid7h4.js";function c({videoUrl:i}){return e.jsxs("div",{className:"theory-container",children:[e.jsx("section",{className:"theory-section",children:e.jsx("h1",{className:"theory-title",children:"Алгоритмическое мышление и Big O"})}),i&&e.jsx(n,{src:i}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"Что такое алгоритм?"}),e.jsx("p",{className:"theory-intro",children:"Алгоритм — это пошаговая инструкция для решения задачи. Как рецепт в кулинарии: нужно делать шаги в правильном порядке, чтобы получить результат."}),e.jsx("p",{className:"theory-intro",style:{marginTop:"12px"},children:"Свойства алгоритма:"}),e.jsxs("ul",{className:"theory-list",children:[e.jsxs("li",{className:"theory-list-item",children:[e.jsx("strong",{children:"Конечность"})," — алгоритм должен закончиться, не бежать вечно"]}),e.jsxs("li",{className:"theory-list-item",children:[e.jsx("strong",{children:"Определённость"})," — каждый шаг должен быть ясным и однозначным"]}),e.jsxs("li",{className:"theory-list-item",children:[e.jsx("strong",{children:"Ввод"})," — алгоритм принимает входные данные"]}),e.jsxs("li",{className:"theory-list-item",children:[e.jsx("strong",{children:"Вывод"})," — алгоритм выдаёт результат"]}),e.jsxs("li",{className:"theory-list-item",children:[e.jsx("strong",{children:"Эффективность"})," — алгоритм должен работать за разумное время"]})]}),e.jsx(r,{title:"Пример: Рецепт чая",children:e.jsxs("ol",{style:{paddingLeft:"20px",color:"var(--text-secondary)",fontSize:"13px"},children:[e.jsx("li",{children:"Налей воду в чайник"}),e.jsx("li",{children:"Включи чайник"}),e.jsx("li",{children:"Жди, пока вода закипит"}),e.jsx("li",{children:"Налей горячую воду в кружку"}),e.jsx("li",{children:"Положи пакетик чая"}),e.jsx("li",{children:"Жди 3-5 минут"}),e.jsx("li",{children:"Достань пакетик"}),e.jsx("li",{children:"Добавь сахар (по желанию)"}),e.jsx("li",{children:"Чай готов!"})]})})]}),e.jsxs("section",{className:"theory-section",children:[e.jsx("h2",{className:"theory-heading-2",children:"Примеры алгоритмов"}),e.jsxs("div",{className:"theory-subsection",children:[e.jsx("h3",{className:"theory-heading-3",children:"Алгоритм: Найти максимум в списке"}),e.jsx(s,{code:`def find_max(numbers):
    max_value = numbers[0]
