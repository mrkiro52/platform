...
function seed() {
  ...
  const juneTitles = [
    ...
    'IT-тренды и влияние ИИ на профессии',
    'Тестирование, комментарии и документация',
