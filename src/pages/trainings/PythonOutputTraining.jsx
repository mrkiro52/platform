      ...
      {phase === 'question' && questions[currentIndex] && (
        <div>
          ...
          {!isAnswered && (
            <button
              ...
              style={{
                ...
                background: 'var(--accent-lime)', color: 'var(--on-accent)', outline: 'none',
          ...
          {isAnswered && (
            <div>
              <div style={{
                marginBottom: 12, padding: '12px 14px', border: `1px solid ${lastCorrect ? 'var(--accent-lime)' : 'var(--danger)'}`,
                background: lastCorrect ? 'rgba(255,214,10,0.06)' : 'rgba(255,51,51,0.06)',
              }}>
                <div style={{ fontWeight: 700, fontSize: 14, color: lastCorrect ? 'var(--accent-lime)' : 'var(--danger)', marginBottom: lastCorrect ? 0 : 8 }}>
