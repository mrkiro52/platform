...
const JULY_SCHEDULE_FALLBACK = [
  ...
  { day:16, date:'чт, 16 июля', meeting_time:'20:00', title:'Качаем статистику: распределения', tracks:['Аналитика','ML'], description:'Вариационный ряд, таблица частот, виды распределений, площадь под кривой, среднее, дисперсия, перцентили и квартили.' },
  { day:16, date:'чт, 16 июля', meeting_time:'20:30', title:'Все виды баз данных: сходства и отличия', tracks:['Frontend','Backend'], description:'Реляционные, документные, key-value, колоночные, графовые БД и поисковые движки — сходства, отличия, команды.' },
  { day:16, date:'чт, 16 июля', meeting_time:'21:00', title:'Технические средства охраны', tracks:['Кибербезопасность'], description:'Датчик разбития стекла, PIR-датчик движения, датчик открытия двери: принципы работы, установка и комбинирование.' },
