...
const JULY_SCHEDULE_FALLBACK = [
  ...
  { day:14, date:'вт, 14 июля', meeting_time:'20:30', title:'Линейная алгебра: векторы', tracks:['Аналитика'], description:'Векторы, операции, скалярное произведение, линейная зависимость, базис и размерность.' },
