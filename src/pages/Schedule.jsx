...
const JULY_SCHEDULE_FALLBACK = [
  ...
  { day:15, date:'ср, 15 июля', meeting_time:'20:00', title:'Линейная алгебра: векторы', tracks:['Аналитика'], description:'Векторы, операции, скалярное произведение, линейная зависимость, базис и размерность.' },
