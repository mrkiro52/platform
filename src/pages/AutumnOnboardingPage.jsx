...
export default function AutumnOnboardingPage() {
  ...
  return (
    <section className="page active">
      ...
      <div className="page-header">
        <h1 className="page-title">Онбординг участника</h1>
        <p className="page-subtitle">Всё, что нужно сделать до старта осеннего лагеря 2026</p>
      </div>
