  ...
  return (
    <div className="theory-container">
      <section className="theory-section">
        ...
        <p>
          Два дня — на самостоятельную работу над <strong>пет-проектом</strong>: небольшим полноценным проектом,
          который ты делаешь для себя, а не по заданию куратора. Это то, что реально показывают на собеседовании —
          гораздо убедительнее, чем «прошёл курс». Ниже — как выбрать идею, требования к оформлению, инструкция по
          деплою и по <strong>5 сильных идей</strong> для каждого трека: веб-разработка, машинное обучение,
          аналитика, кибербезопасность.
        </p>
      </section>

      <section className="theory-section">
        <h2 className="theory-heading-2">1. Зачем нужен пет-проект</h2>
        <P n={1}>
          Курсовые задания решаются по готовому условию — пет-проект заставляет самому принимать решения: какую
          структуру данных выбрать, как назвать эндпоинт, что делать при ошибке. Именно эти решения и спрашивают
          на собеседованиях. К тому же готовый проект в GitHub — это то, что можно <strong>показать</strong>,
          а не просто перечислить в резюме.
        </P>
        <P n={2}>
          Хороший пет-проект небольшой, но <strong>доведён до конца</strong>: работает, задеплоен, у него есть
          README. Лучше маленький завершённый проект, чем амбициозный недоделанный — рекрутер и наставник в первую
          очередь смотрят, доводишь ли ты дело до результата.
        </P>
      </section>

      <section className="theory-section">
        <h2 className="theory-heading-2">2. Как выбрать идею</h2>
        <P n={3}>
          Выбирай идею, которая заставит применить именно те навыки, что ты хочешь показать в резюме, и делай её
          чуть сложнее зоны комфорта — ровно настолько, чтобы пришлось гуглить и разбираться, но не тонуть.
          Ниже — готовые идеи по каждому треку, но их не обязательно брать один в один: можно менять предметную
          область, если суть и стек тебе откликаются.
        </P>
      </section>

      <section className="theory-section">
        <h2 className="theory-heading-2">3. Требования к оформлению репозитория</h2>
        <P n={4}>
      ...
      <section className="theory-section">
        <h2 className="theory-heading-2">4. Структура README</h2>
        <P n={5}>
...
Имя · [telegram](https://t.me/username) · [резюме](https://...)`} />
      ...
      <section className="theory-section">
        <h2 className="theory-heading-2">5. Деплой: где размещать проект</h2>
        <P n={6}>
      ...
      <section className="theory-section">
        <h2 className="theory-heading-2">6. Команды для запуска — что должно быть готово</h2>
        <P n={7}>
...
docker compose up --build`} />
      ...
      {/* ===== ВЕБ-РАЗРАБОТКА ===== */}
      <section className="theory-section">
        <h2 className="theory-heading-2">7. Идеи пет-проектов: Веб-разработка</h2>
        <P n={8}>
      ...
      {/* ===== MACHINE LEARNING ===== */}
      <section className="theory-section">
        <h2 className="theory-heading-2">8. Идеи пет-проектов: Machine Learning</h2>
        <P n={9}>
      ...
      {/* ===== АНАЛИТИКА ===== */}
      <section className="theory-section">
        <h2 className="theory-heading-2">9. Идеи пет-проектов: Аналитика данных</h2>
        <P n={10}>
      ...
      {/* ===== КИБЕРБЕЗОПАСНОСТЬ ===== */}
      <section className="theory-section">
        <h2 className="theory-heading-2">10. Идеи пет-проектов: Кибербезопасность</h2>
        <P n={11}>
      ...
      <section className="theory-section">
        ...
        <P n={12}>
          Пет-проект — это то, что реально показывают на собеседовании, поэтому важнее <strong>довести до
          конца</strong>, чем сделать амбициозно, но незавершённо. Обязательный минимум оформления — README с
          описанием, скриншотом и командами запуска, <code>.gitignore</code>, зафиксированные зависимости и
          никаких секретов в репозитории. Frontend-проекты деплоят на GitHub Pages/Vercel, проекты с бэкендом — на
          Render/Railway. Выбери одну из идей своего трека (или похожую по духу), учитывающую именно те навыки,
          которые хочешь закрепить — и за эти два дня доведи её до рабочей, задеплоенной версии с внятным README.
        </P>
      </section>
    </div>
  )
