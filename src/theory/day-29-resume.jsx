...
const Card = ({ children, accent }) => (
  <div style={{
    ...
    border: `1px solid ${accent ? 'rgba(200,255,0,0.3)' : 'var(--border-color)'}`,
    borderRadius: 10,
...
const Note = ({ children }) => (
  <div style={{ background: 'rgba(200,255,0,0.05)', border: '1px solid rgba(200,255,0,0.18)', borderRadius: 8, padding: '12px 16px', margin: '14px 0', fontSize: 13.5, lineHeight: 1.7, color: 'var(--text-secondary)' }}>
