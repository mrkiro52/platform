...
const Quote = ({ text, author }) => (
  <div style={{
    ...
    background: 'rgba(255,214,10,0.04)', borderRadius: '0 8px 8px 0',
  }}>
  ...
  return (
    <Viz>
      ...
      <div style={{ border: '1.5px solid var(--accent-lime)', borderRadius: 10, padding: '14px 16px', background: 'rgba(255,214,10,0.04)' }}>
        ...
        <div style={{ borderTop: '1px dashed rgba(255,214,10,0.2)', paddingTop: 10, fontSize: 12, color: 'var(--text-tertiary)', fontStyle: 'italic' }}>
          Пример: {p.ex}
        </div>
      </div>
    </Viz>
